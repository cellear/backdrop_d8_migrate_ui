...
abstract class MultilingualReviewPageTestBase extends MigrateUpgradeTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['migrate_backdrop_ui'];
   ...
   *
   * @see \Drupal\Tests\migrate_backdrop_ui\Functional\MigrateUpgradeExecuteTestBase
   */
  public function testMigrateUpgradeReviewPage() {
    ...
    // @see \Drupal\migrate_backdrop_ui\Form\ReviewForm::$noUpgradePaths
    $module = 'help';
