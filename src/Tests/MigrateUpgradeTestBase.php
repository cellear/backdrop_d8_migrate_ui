...
namespace Drupal\migrate_backdrop_ui\Tests;

@trigger_error('\Drupal\migrate_backdrop_ui\Tests\MigrateUpgradeTestBase is deprecated in Drupal 8.4.0 and will be removed before Drupal 9.0.0. Use \Drupal\Tests\migrate_backdrop_ui\Functional\MigrateUpgradeTestBase instead.', E_USER_DEPRECATED);
 ...
 *   \Drupal\Tests\migrate_backdrop_ui\Functional\MigrateUpgradeTestBase instead.
 */
abstract class MigrateUpgradeTestBase extends WebTestBase {
  ...
  protected function setUp() {
    ...
    $this->sourceDatabase = Database::getConnection('default', 'migrate_backdrop_ui');
  ...
  protected function createMigrationConnection() {
    ...
    Database::addConnectionInfo('migrate_backdrop_ui', 'default', $connection_info);
  }
  ...
  protected function tearDown() {
    Database::removeConnection('migrate_backdrop_ui');
    parent::tearDown();
  }
