...
class OverviewForm extends MigrateUpgradeFormBase {
  ...
  public function getFormId() {
    return 'migrate_backdrop_ui_overview_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // form.
    if ($this->state->get('migrate_backdrop_ui.performed')) {
      $this->store->set('step', 'incremental');
      return $this->redirect('migrate_backdrop_ui.upgrade_incremental');
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('migrate_backdrop_ui.upgrade_credential');
  }
