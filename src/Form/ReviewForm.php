...
use Drupal\migrate_backdrop_ui\Batch\MigrateUpgradeImportBatch;
...
class ReviewForm extends MigrateUpgradeFormBase {
  ...
  public function getFormId() {
    return 'migrate_backdrop_ui_review_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attached']['library'][] = 'migrate_backdrop_ui/base';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->state->set('migrate_backdrop_ui.performed', REQUEST_TIME);
  }
