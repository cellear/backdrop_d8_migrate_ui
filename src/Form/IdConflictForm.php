...
class IdConflictForm extends MigrateUpgradeFormBase {
  ...
  public function getFormId() {
    return 'migrate_backdrop_ui_idconflict_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($content_conflicts || $translated_content_conflicts) {
      ...
      return $this->redirect('migrate_backdrop_ui.upgrade_review');
    }
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->store->set('step', 'review');
    $form_state->setRedirect('migrate_backdrop_ui.upgrade_review');
  }
