...
namespace Drupal\migrate_backdrop_ui\Form;
...
class CredentialForm extends MigrateUpgradeFormBase {
  ...
  public function getFormId() {
    return 'migrate_backdrop_ui_credential_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#title'] = $this->t('Drupal 6, Drupal 7, Backdrop Migrate');
    ...
    $form['help'] = [
      '#type' => 'item',
      '#description' => $this->t('Provide the information to access the Backdrop or Drupal site you want to migrate. Files can be imported into the upgraded site as well.  See the <a href=":url">Upgrade documentation for more detailed instructions</a>.', [':url' => 'https://www.drupal.org/upgrade/migrate']),
    ];

    $form['version'] = [
      '#type' => 'radios',
      '#default_value' => 7,
      '#title' => $this->t('Drupal or Backdrop version of the source site'),
      '#options' => ['Backdrop' => $this->t('Backdrop'),'6' => $this->t('Drupal 6'), '7' => $this->t('Drupal 7')],
      '#required' => TRUE,
    ];
    ...
    $form['database'] = [
      ...
      '#description' => $this->t('Provide credentials for the database of the Drupal or Backdrop site you want to upgrade.'),
      '#open' => TRUE,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('migrate_backdrop_ui.upgrade_idconflict');
  }
